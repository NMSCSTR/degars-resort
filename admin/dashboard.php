                        ...
                        <div class="card l-bg-cherry">
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="progress mt-1 " data-height="8" style="height: 8px;">
                                    <div class="progress-bar l-bg-cyan" role="progressbar" data-width="<?php echo $productProgressWidth; ?>%"
                                        aria-valuenow="<?php echo $productProgressWidth; ?>%" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $productProgressWidth; ?>%;"></div>
                                </div>
                            </div>
                        </div>                        
                    </a>
