                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item dropdown">
                        <a class="nav-link active dropdown-toggle" data-bs-toggle="dropdown"
                            href="walkinReservations.php" role="button" aria-expanded="false">Room
                            <span
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark">
                            ...
                            <li><a class="dropdown-item" href="reservations.php"><span class="d-inline-block bg-success rounded-circle p-1"></span> Exclusive Reservations</a></li>
                            <li><a class="dropdown-item" href="walkinReservation.php"><span class="d-inline-block bg-info rounded-circle p-1"></span> Walkin Reservations</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
