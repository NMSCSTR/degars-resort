...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($uploadOk) {
        ...
        if (isset($_POST['aminities_id']) && !empty($_POST['aminities_id'])) {
            ...
            $sqlSelect = "SELECT `image1`, `image2`, `image3` FROM `aminities` WHERE `aminities_id` = $id";
            ...
            $sqlInsert = "INSERT INTO `aminities` (`name`, `rates`, `description`, `image1`, `image2`, `image3`) VALUES ('$name', '$rates', '$description', '$image1', '$image2', '$image3')";
