...
$approvedcrstatus = mysqli_query($db, "UPDATE `completed_reservation` SET `status` ='Approved', `approvedby` = '$approvedby' WHERE `reservation_id` = $reservation_id AND customer_id = $customer_id ");
