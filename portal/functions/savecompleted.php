...
curl_setopt_array($curl, [
    ...
    'data' => [
        'attributes' => [
            ...
            'cancel_url' => 'http://192.168.51.5/degars-resort/portal/exclusive/failed.php?reservation_id=' . $reservation_id . '&customer_id=' . $customer_id,
            'description' => 'Exclusive & Package Reservation Payment - ' . $transaction_ref,
            ...
            'success_url' => 'http://192.168.51.5/degars-resort/portal/exclusive/success.php?reservation_id=' . $reservation_id . '&customer_id=' . $customer_id,
            'line_items' => [
                [
                    'currency' => 'PHP',
                    'amount' => $totalamount,
