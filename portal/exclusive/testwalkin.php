    ...
    <div class="container-sm mt-5">
        <div class="row g-0 position-relative">
            ...
            <div class="container-fluid col-md-8 p-4 ps-md-0">
                <h5 class="mt-0 fw-bold"><i class="fas fa-calendar-alt"></i> WALK-IN | <span
                        class="text-success">ADVANCE PAYMENT</span> </h5>
                <hr>
                <form action="../functions/savetestwalkin.php" method="post">
                    <a href=""
                        class="d-flex justify-content-end link-primary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover"
                        data-bs-toggle="modal" data-bs-target="#exampleModal">View Aminities</a>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control text-capitalize fw-bold" name="entrancefee"
                            ...
                            required readonly>
                        <label for="floatingInput"><i class="fas fa-dollar-sign"></i> Entrance fee (4 years old
                            above)</label>
                    </div>
                    <!-- Inside your form -->
                    <div class="form-floating mb-3">
                        <input type="date" class="form-control text-capitalize fw-bold" name="walkindate"
                            id="floatingInput">
                        <label for="floatingInput"><i class="fas fa-calendar"></i> Walk-in Date</label>
                    </div>
                    ...
                    <div class="selectAminities">
                        <p>Select Aminities</p>
                        <?php 
                        $db = mysqli_connect('localhost', 'root', '', 'capstwo');
                        $fetch_all = "SELECT * FROM `aminities` ORDER BY dateadded DESC";
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="amenities[]"
                                value="<?php echo $option['aminities_id']; ?>"
                                id="flexCheckDefault<?php echo $option['aminities_id']; ?>">
                            <label class="form-check-label"
                                for="flexCheckDefault<?php echo $option['aminities_id']; ?>">
