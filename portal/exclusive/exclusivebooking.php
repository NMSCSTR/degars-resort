        ...
        <div class="row g-0 position-relative">
            ...
            <div class="col-md-6 p-4 ps-md-0">
                ...
                <form action="" method="post">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control text-uppercase fw-bold" value="Birthday Party" id="floatingInput"
                            placeholder="Event name">
                        <label for="floatingInput"><i class="fas fa-pencil-alt"></i> Event Name</label>
                    </div>
                    <div class="form-floating mb-3">
                    ...
                    <div class="form-floating mb-3">
                        <select class="form-select text-uppercase fw-bold" id="floatingSelect"
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control text-uppercase fw-bold" value="PHP 5600" id="floatingInput"
                            placeholder="rates">
                        <label for="floatingInput"><i class="fas fa-money-bill"></i> Rates</label>
                    </div>
                    <div class="d-flex justify-content-end gap-2">
                        <a href="http://192.168.1.8/degars-resort/portal/quickstart.php" class="btn btn-outline-danger"> Back</a>
                        <div class="vr"></div>
