        ...
        <div class="row g-0 position-relative">
            ...
            <div class="col-md-6 p-4 ps-md-0">
                ...
                <form action="" method="post">
                    ...
                    <div class="form-floating mb-3">
                        <input type="date" class="form-control fw-bold" id="floatingInput"
                            placeholder="select date">
                        <label for="floatingInput"><i class="fas fa-calendar-day"></i> Select Date </label>
                    </div> -->
                    <div class="form-floating mb-3">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control text-capitalize fw-bold" value="PHP 5600" id="floatingInput"
                            placeholder="rates">
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <div class="vr"></div>
                        <a href="review.php"class="btn btn-dark" name="submitExclusuveReservation">Proceed </a>
                    </div>
                </form>
            </div>
        </div>
